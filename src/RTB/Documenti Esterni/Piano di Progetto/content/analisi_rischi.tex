...
In questa sezione il gruppo descrive l'analisi dei potenziali rischi associati al progetto$^G$.\\
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{|>{\bfseries}m{0.25\textwidth}|m{0.65\textwidth}|}
			...
			Mitigazione & Pianificare task$^G$ realistiche e suddividere task$^G$ grandi in sotto-task$^G$. \\ \hline
